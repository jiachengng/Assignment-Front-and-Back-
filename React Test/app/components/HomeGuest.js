...
function HomeGuest() {
  ...
  async function handleSubmit(e) {
    e.preventDefault()
    try {
      // await Axios.post("http://localhost:8080/logIn", { username, email, password })
        ...
        <div className="col-lg-5 pl-lg-5 pb-3 py-lg-10" style={{ margin: "auto" }}>
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <input onChange={e => setUsername(e.target.value)} id="username-register" name="username" className="form-control" type="text" placeholder="Pick a username" autocomplete="off" required />
            </div>
            <div className="form-group">
